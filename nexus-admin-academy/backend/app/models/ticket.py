...
class TicketSubmission(Base):
    ...
    __table_args__ = (
        CheckConstraint("ai_score BETWEEN 0 AND 10", name="ck_ticket_submissions_ai_score"),
    ...
    ai_feedback: Mapped[dict] = mapped_column(JSON().with_variant(JSONB, "postgresql"), nullable=False)
