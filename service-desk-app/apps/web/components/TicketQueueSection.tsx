...
export function TicketQueueSection({
  ...
  return (
    <Card aria-label={label}>
      ...
      />
      <div className="hidden grid-cols-[8rem_minmax(0,1fr)_10rem_8rem_1.25rem] gap-3 border-y border-border bg-surface/50 px-4 py-2 text-[11px] font-extrabold uppercase tracking-wide text-text-muted sm:grid">
        <span>Priority</span>
        <span>Ticket</span>
        <span>Requester</span>
        <span>Status</span>
