...
export {
  ...
  type WorkstationAccess,
  type WorkstationComplianceState,
  type WorkstationCredential,
  type WorkstationDesktopState,
  type WorkstationDnsCacheEntry,
  type WorkstationFilesystemNode,
  type WorkstationFilesystemState,
  type WorkstationInterfaceStatus,
  type WorkstationIpv4State,
  type WorkstationKnownHost,
  type WorkstationMachineState,
  type WorkstationMappedDrive,
  type WorkstationNetworkInterface,
  type WorkstationNetworkState,
  type WorkstationProfileState,
  type WorkstationRoute,
  type WorkstationService,
  type WorkstationState,
  type WorkstationTerminalEntry,
  type WorkstationTerminalState,
  type WorkstationVpnLogEntry,
  type WorkstationVpnProfile,
  type WorkstationVpnState,
