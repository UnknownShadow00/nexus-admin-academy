...
export default function StepPanel({ lesson, currentStepIndex, completedStepIds, onCompleteStep, onContinue, disabled = false }) {
  ...
  return (
    <section className="panel space-y-4 dark:border-slate-700 dark:bg-slate-900">
      ...
      <fieldset className="contents disabled:opacity-60" disabled={disabled}>
        {renderStep()}
