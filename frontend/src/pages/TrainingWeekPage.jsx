...
export default function TrainingWeekPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl space-y-6 p-4 pb-20 sm:p-6">
      ...
      <ActivitySection title="4. Apply" description="Use what you learned on a real Service Desk case." items={requiredApply} nextId={nextId} onWatched={handleWatched} returnTo={returnTo} weekNumber={week.week_number} cliPracticeRoute={cliPracticeRoute} />
