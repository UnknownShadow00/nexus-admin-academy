...
export default function TrainingDashboardPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl space-y-6 p-4 pb-20 sm:p-6">
      <div>
        <h1 className="text-3xl font-bold text-slate-950 dark:text-white">My Training</h1>
        <p className="mt-1 text-slate-600 dark:text-slate-300">Your weekly path through learning, quizzes, and hands-on practice.</p>
      </div>
      <TrainingSubnav />
      ...
      {week ? (
        <section className="overflow-hidden rounded-2xl bg-gradient-to-br from-blue-700 to-indigo-700 p-5 text-white shadow-lg sm:p-7">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-100">{data.training_complete ? "Training Complete" : "Current Week"}</p>
          <h2 className="mt-2 text-2xl font-bold sm:text-3xl">Week {week.week_number} — {week.title}</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-slate-950 dark:text-white">Weekly Roadmap</h2>
