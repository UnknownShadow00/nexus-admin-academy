...
describe("V2MentorStudentPage", () => {
  it("renders detailed misses, Explain state, engine links, and external practice", async () => {
    ...
    expect(screen.getByText(/Blocked by: Explain awaiting mentor review/)).toBeInTheDocument();
    expect(screen.getByRole("link", { name: "Open recovery" })).toHaveAttribute("href", "/admin/v2-grading/8");
  });
});
