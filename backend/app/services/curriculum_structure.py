...
STAGES = (
    ...
    StageDefinition("stage.network_administration", "Network+ Switching & Services", "Build Network+ foundations in switching, routing, and common network services after completing A+.", 4),
