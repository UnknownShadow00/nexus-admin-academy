...
STAGES = (
    ...
    StageDefinition("stage.microsoft_workplace", "Microsoft 365, Entra & Endpoint Management", "Support Microsoft 365 identity, mail, and collaboration tools the way a first-line technician actually does: read the evidence, verify identity, act within least privilege, escalate what you shouldn't fix alone. Endpoint/Intune/device-lifecycle content is planned for Phase 4B.2; see docs/MICROSOFT_WORKPLACE_CURRICULUM.md.", 5),
