    ...
    },
    {
        ...
        "questions": [
            ...
            _q("A user can't ping ANYTHING, including devices on their own subnet. Layer to check first:",
               "DNS resolution layer", "Physical and switching layer", "Routing and gateway layer", "Application service layer",
    ...
    },
    {
        ...
        "questions": [
            ...
            _q("A switch port shows 'administratively down'. To bring it up:",
               "Replace the switch hardware", "Run no shutdown on the interface", "Change the access VLAN", "Save the running configuration",
            ...
            _q("A port shows 'err-disabled'. Running 'no shutdown' without more:",
               "Permanently fixes the port", "May re-disable if cause remains",
    ...
    },
    {
        ...
        "questions": [
            ...
            _q("A native VLAN mismatch between two trunk ends causes:",
               "Complete trunk link failure", "Traffic leakage and mismatch warnings",
            ...
            _q("A whole new VLAN gets no IP (APIPA) but the DHCP server and other VLANs are fine. Likely cause:",
               "The DHCP server is down", "Missing DHCP relay on the VLAN interface",
            ...
            _q("A host reaches its own VLAN but no other network. Besides gateway config, suspect:",
               ...
               "A failed patch cable", "A port-security violation",
    ...
    },
    {
        ...
        "questions": [
            ...
            _q("A port is err-disabled. show port-security shows a violation. The RIGHT recovery:",
               "Run no shutdown immediately", "Fix the violation, then re-enable",
            ...
            _q("Why do network changes demand more caution than a single desktop fix?",
               "They have no extra risk", "Shared changes affect many users",
            ...
            _q("You save a switch's config off-device primarily so that:",
               "It increases switching throughput", "Recover configuration after hardware failure",
