    ...
    },
    {
        ...
        "questions": [
            ...
            _q("Which CLI mode do you configure a single port in?",
               "User EXEC mode", "Interface configuration mode", "Privileged EXEC mode", "Global configuration mode",
            ...
            _q("A port shows 'err-disabled'. Running 'no shutdown' without more:",
               "Permanently fixes the port", "May re-disable because the cause remains",
    ...
    },
    {
        ...
        "questions": [
            ...
            _q("A native VLAN mismatch between two trunk ends causes:",
               "Complete link failure", "Traffic leakage and mismatch warnings",
            ...
            _q("A whole new VLAN gets no IP (APIPA) but the DHCP server and other VLANs are fine. Likely cause:",
               ...
               "All access cables failed", "DNS resolution failed",
