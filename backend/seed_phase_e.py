...
QUIZZES_E = [
    {
        ...
        "questions": [
            ...
            _q("chmod 777 on a web file to 'make it work' is bad because it:",
               ...
               "Deletes the target file", "Requires a system reboot",
               "B", "777 is the Linux equivalent of Full Control to Everyone."),
            _q("On a DIRECTORY, the execute (x) permission means:",
               "Run it as a program", "Enter and traverse it", "Delete the directory", "No access at all",
            ...
            _q("You get 'Permission denied' editing a system file. The likely need (used carefully) is:",
               "chmod 777 permissions", "Use sudo for the command", "Restart the system", "Delete the file",
            ...
            _q("SSH refuses your key with 'Permission denied (publickey)'. A classic cause is:",
               "The server is powered off", "Bad .ssh permissions or key",
    ...
    },
    {
        ...
        "questions": [
            _q("To see whether a service is running, failed, and enabled at boot, run:",
               "journalctl -f", "systemctl status <service>", "ps aux process list", "top performance view",
            ...
            _q("To read the actual error a failed service produced:",
               "Ping the server", "journalctl -u <service> -e", "Change binary permissions", "Restart the server",
            ...
            _q("Restarting a failed service without reading its logs typically results in:",
               ...
               "Immediate data loss", "A full system reboot",
            ...
            _q("To confirm WHEN a cron job was scheduled to run, you:",
               "Guess from prior runs", "Read the five crontab fields", "Restart the cron service", "Check firewall rules",
