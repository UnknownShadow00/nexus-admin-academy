...
QUIZZES_D = [
    {
        ...
        "questions": [
            _q("What is an Organizational Unit (OU) primarily used for?",
               "Configuring client IP assignment", "Organizing objects and applying GPOs",
    ...
    },
    {
        ...
        "questions": [
            ...
            _q("Moving a computer account to a different OU can change:",
               "Its assigned network address", "Its applicable Group Policies", "Its hardware MAC address", "Its configured hostname",
    ...
    },
    {
        ...
        "questions": [
            ...
            _q("gpresult shows the GPO is NOT applied and was filtered. A common cause:",
               "A failed network cable", "Wrong OU or security filtering",
    ...
    },
    {
        ...
        "questions": [
            ...
            _q("Which cmdlet finds all locked-out accounts?",
               "Get-Process", "Search-ADAccount -LockedOut", "Restart-Service", "Get-Help for AD commands",
            ...
            _q("Before running a bulk CHANGING command against many objects, you should:",
               "Run it against all targets first", "Preview with read-only or -WhatIf",
