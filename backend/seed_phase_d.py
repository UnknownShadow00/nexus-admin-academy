    ...
    },
    {
        ...
        "questions": [
            ...
            _q("After restoring a deleted file, you must:",
               "Close the ticket", "Verify the file and permissions",
            ...
            _q("The 3-2-1 backup principle means:",
               "Three servers and two admins", "Three copies, two media, one offsite",
            ...
            _q("Invoke-Command -ComputerName s1,s2 { Get-Service DNS } does what?",
               "Installs the DNS role", "Runs a command on both servers",
               "Deletes the DNS service", "Restarts both named servers",
