...
QUIZZES_D = [
    {
        ...
        "questions": [
            _q("What is an Organizational Unit (OU) primarily used for?",
               "Assigning client IP addresses", "Organizing objects and applying GPOs",
            ...
            _q("After adding a user to a new security group, they still can't access the resource. Missing step:",
               "Restart the domain controller", "Refresh the user's sign-in token",
            ...
            _q("To reset a user's password in AD you should also typically:",
               "Delete the user's profile", "Verify identity and require a change",
               "Disable the user account", "Remove every group membership",
    ...
    },
    {
        ...
        "questions": [
            ...
            _q("Moving a computer account to a different OU can change:",
               "Its assigned IP address", "Its applicable Group Policies", "Its hardware MAC address", "Its configured hostname",
            ...
            _q("'My mapped drive is missing' in a domain is often caused by:",
               ...
               "A workstation virus infection", "Incorrect DNS resolution",
    ...
    },
    {
        ...
        "questions": [
            ...
            _q("A setting expected from a domain GPO is being overridden. Most likely:",
               "The server is unavailable", "A closer GPO takes precedence",
            ...
            _q("gpresult shows the GPO is NOT applied and was filtered. A common cause:",
               "A failed network cable", "Wrong OU or security filter",
    ...
    },
    {
        ...
        "questions": [
            _q("Why does Active Directory depend on DNS?",
               "It makes internet access faster", "Clients locate domain controllers",
            ...
            _q("Which cmdlet finds all locked-out accounts?",
               "Get-Process", "Search-ADAccount -LockedOut", "Restart-Service", "Get-Help command",
            ...
            _q("Before running a bulk CHANGING command against many objects, you should:",
               "Run it and inspect results", "Preview with read-only or -WhatIf",
